...
if (METHOD === 'GET') {
    ...
    $query = "SELECT id,property,due_date,start_date,end_date,active FROM property_contracts WHERE property = $property AND (active = 0 OR start_date <= CURDATE() AND end_date < CURDATE())";
